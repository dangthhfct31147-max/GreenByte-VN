# =============================================================================
# RAILWAY DEPLOYMENT GUIDE - GreenByte
# =============================================================================
...
1. Tạo thêm Service mới: **New** -> **GitHub Repo** -> Chọn `GreenByte`.
2. Vào **Settings** -> **Build** -> **Dockerfile Path** -> Nhập `Dockerfile.frontend`.
3. Vào **Variables**:
   - `VITE_API_URL`: `https://greenbyte-backend.up.railway.app` (Domain backend).
